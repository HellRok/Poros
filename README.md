...
If you want to use an attribute that's actually a class like `Date` you will
need to specifically allow it. This is a safety feature of YAML and will help
protect your code base from malicious users.
...
`self.data_directory` you can redefine this method if you don't want it to
save to the default of `./db/#{self}`. If you do redefine it you _must_
seperate each model into its own folder or it will have _lots_ of issues.
